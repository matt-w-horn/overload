...
- `Calculus.lean`: amplification sensitivity, loop gain by the chain
  ...
  the trajectory as a hypothesis. For `smoothLoop`, local existence from any
  positive initial backlog is proved by Picard–Lindelöf
  (`smoothLoop_exists_trajectory`).
